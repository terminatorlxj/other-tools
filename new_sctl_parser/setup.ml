...
(* OASIS_START *)
(* DO NOT EDIT (digest: 3a2c11d483719ecdd094f3e53ce61917) *)
(*
...
let setup_t =
  {
     ...
     build = OCamlbuildPlugin.build ["-use-menhir"; "-yaccflag"; "--explain"];
     test = [];
     doc = [];
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "Tool that verifies CTLP properties of finite state models.";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Lists"; "Options"; "Pairs"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "utils";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "parsing"; InternalLibrary "utils"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "parsing"; InternalLibrary "typing"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest = Some ":-{\135\170\224\128\136\025T!Rv\169A\015";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
