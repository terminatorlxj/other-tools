(* OASIS_START *)
(* DO NOT EDIT (digest: 2fe077cb2318272638f5d05e09f04bd7) *)
...
let package_default =
  {
     ...
     includes =
       [
          ("src/typing", ["src/parsing"; "src/utils"]);
          ("src/proving", ["src/parsing"; "src/typing"]);
          ("src", ["src/parsing"; "src/proving"; "src/typing"])
       ]
  }
  ;;
